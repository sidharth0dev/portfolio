...
const projects: Project[] = [
  ...
  {
    id: 3,
    title: "AI-Enhanced Productivity App",
    hook: "A smart task manager that uses AI to prioritize your to-do list and suggest optimal workflows.",
    description: "This isn't just another to-do list. By integrating with the OpenAI API, this application analyzes your tasks, deadlines, and project categories to intelligently suggest what to work on next. It helps break down large tasks into smaller, manageable steps and and provides motivational feedback, acting as a personal productivity assistant.",
    tech: ['React', 'Node.js', 'OpenAI API', 'MongoDB'],
    githubUrl: '#',
    liveUrl: '#',
    visual: '', // No video for this one yet
  },
];
...
const certifications: Certification[] = [
  ...
  },
  {
    ...
    issuer: 'Google & VIT',
    description: 'Successfully completed the foundational program covering core Google Cloud concepts.',
    filePath: '/certs/google-cloud-foundations.pdf',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    description: 'Course covering the fundamental concepts and applications of Generative AI.',
    filePath: '/certs/linkedin-gen-ai.pdf',
  },
  {
    id: 6,
    title: 'Create Your First Python Program',
    issuer: 'UST & Coursera',
    description: 'A project-based course on the fundamentals of programming in Python.',
    filePath: '/certs/ust-python.pdf',
  },
];

const skills = {
    "Core Technologies": ['Python', 'Java', 'C', 'C++','JavaScript', 'React', 'Node.js', 'Next.js', 'Django', 'HTML/CSS'],
    "Infrastructure & Databases": ['Google Cloud (GCP)', 'AWS', 'Firebase', 'Docker', 'Git', 'Github', 'CI/CD', 'PostgreSQL', 'MongoDB'],
    "AI & Creative Suite": ['Prompt Engineering', 'OpenAI API', 'Adobe After Effects', 'Premiere Pro', 'Figma', 'CapCut']
};
...
const Navbar = () => {
    ...
    const navLinks = ["About", "Projects", "Certifications", "Contact"];
  ...
  return (
    ...
    >
      ...
      <motion.p variants={itemVariants} className="mt-4 text-lg md:text-xl max-w-2xl mx-auto md:mx-0 text-gray-400 font-sans">
        A Full-Stack Developer and creative Video Editor, transforming complex problems into seamless digital experiences.
      </motion.p>
        ...
        <div className="grid md:grid-cols-5 gap-12 items-center">
            ...
            >
                ...
                <div className="absolute inset-0 bg-[#141414] rounded-2xl shadow-2xl p-4 transform hover:rotate-3 transition-transform duration-500">
                    <div className="w-full h-full bg-cover bg-center rounded-lg" style={{backgroundImage: 'url(/A32A2138.JPG)'}}></div>
                </div>
            </motion.div>
            <motion.div 
            ...
            >
                <p className="text-gray-400 leading-relaxed font-sans text-xl font-medium">
                    As a recent Integrated M.Tech graduate in Computer Science from VIT, I thrive on turning complex problems into elegant, efficient code. I'm a 'vibe coder' at heart, deeply passionate about building full-stack projects from the ground up, leveraging AI and prompt engineering to accelerate productivity and innovate. My skills aren't limited to the terminal; as a video editor, I bring a creative and detail-oriented perspective to my work, ensuring the final product is not just functional, but also compelling. I'm a collaborative team player, ready to learn and adapt to solve challenges and contribute to a company's success.
                </p>
            </motion.div>
        </div>
    </section>
...
const ProjectsSection = ({ projects, setModalData }: { projects: Project[], setModalData: (project: Project) => void }) => (
    <section id="projects" className="py-20">
        <h2 className="text-4xl font-bold text-center mb-4 font-sans">From Scratch & AI-Enhanced</h2>
        <p className="text-center text-gray-400 mb-12 max-w-2xl mx-auto font-sans">Here are some of the projects I'm proud of. Each was a journey of learning, problem-solving, and creation.</p>
...
const ContactSection = () => {
    ...
    <section id="contact" className="py-20 text-center">
        <h2 className="text-4xl font-bold mb-4 font-sans">Let's build something great.</h2>
